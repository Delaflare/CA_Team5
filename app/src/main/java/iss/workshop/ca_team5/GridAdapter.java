...
public class GridAdapter extends BaseAdapter {
    ...
    public void flipBack(int position, int prevPosition){
        if(position >= 0 && position < images.length){
            images[position] = BitmapFactory.decodeResource(context.getResources(), R.drawable.placeholder);
            images[prevPosition] = BitmapFactory.decodeResource(context.getResources(), R.drawable.placeholder);
            notifyDataSetChanged();
        }
    }
